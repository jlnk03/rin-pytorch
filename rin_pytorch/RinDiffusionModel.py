...
class RinDiffusionModel(torch.nn.Module):
    ...
    def denoise(
        ...
        output, latent, tape = self.denoiser(x, gamma, masks, cond, pos_embs, nmh, nmw, latent_prev, tape_prev, tape_length)
    ...
    def sample(
        ...
        for t in tqdm(
            ...
            pred_out, latent_prev, tape_prev = self.denoise(
                samples, gamma, cond, mask_out, pos_embs, nmh, nmw, latent_prev, tape_prev, tape_length=tape_length
            )
    ...
    def noise_denoise(
        ...
        denoise_out, _, _ = self.denoise(images_noised, gamma, labels, masks, pos_embs, nmh, nmw, latent_prev, tape_prev, tape_length=tape_length)
    ...
    def forward(
        ...
        images, noise, _, pred_dict = self.noise_denoise(images, masks, labels, pos_embs, nmh, nmw, t=t, tape_length=tape_length)
