...
# Use validation split for FID (50k images)
DEFAULT_IMAGENET_VAL_ROOT = "/home/stud/ljul/storage/group/dataset_mirrors/imagenet2012/imagenet2012_download/val"
...
def main():
    ...
    parser.add_argument("--imagenet_root", type=str, default=None,
                       help=f"Root directory for ImageNet. Defaults to '{DEFAULT_IMAGENET_VAL_ROOT}' (val split, 50k images).")
    ...
    if args.flexible_cifar:
        ...
        cache_path = get_cache_path(cache_dir, args.feature, "imagenet")
    elif args.cache_dir:
    ...
    if not cache_loaded:
        if args.flexible_cifar:
            ...
            imagenet_root = args.imagenet_root or DEFAULT_IMAGENET_VAL_ROOT
