...
def test_two_level_hierarchy_multiplicative():
    ...
    print(f"  - Effective ratio (multiplicative): 0.5 × 0.25 = {effective_ratio:.3f} (12.5%)")
    print(f"  - Expected sparsity: 1 - {effective_ratio:.3f} = {expected_sparsity:.1%}")
...
def test_three_level_hierarchy():
    ...
    print(f"  - Sequence length: {seq_len}")
    print(f"\nSparsity calculation:")
    print(f"  - Effective ratio (multiplicative): 0.5 × 0.5 × 0.5 = {effective_ratio:.3f} (12.5%)")
    print(f"  - Expected sparsity: 1 - {effective_ratio:.3f} = {expected_sparsity:.1%}")
...
def summarize_results():
    ...
    print("  - Single level (ratio=0.5): 50% sparsity")
    print("  - Two levels (0.5 × 0.25): 87.5% sparsity (MULTIPLICATIVE)")
    print("  - Three levels (0.5 × 0.5 × 0.5): 87.5% sparsity")
    print()
